      ...
      <div class="col-sm-12">
        ...
        <div class="site-block mb70">
          <div class="row">
            ...
            <div class="col-md-12">
              <h3 class="site-heading"><strong><a href="/blog/post/?<?= $articleID ?>"><?= $article->title ?></a></strong></h3>
              <p><?= mb_substr(strip_tags($article->body), 0, 350) ?><a href="/blog/post/?i=<?= $articleID ?>">... Read More</a></p>
            </div>
          </div>
          <div class="clearfix">
            <p class="pull-right">
              <a href="/blog/post/?<?= $articleID ?>" class="label label-primary p10">Read more...</a>
            </p>
