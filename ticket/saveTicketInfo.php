...
$name = (isset($_POST['ticket-name']) and $_POST['ticket-name'])?$_POST['ticket-name']:'';
$email = (isset($_POST['ticket-email']) and $_POST['ticket-email'])?$_POST['ticket-email']:'';
$msg = (isset($_POST['ticket-message']) and $_POST['ticket-message'])?$_POST['ticket-message']:'';
$subj = (isset($_POST['ticket-type']) and $_POST['ticket-type'])?$_POST['ticket-type']:'';
...
try {
  ...
  $newTicket = $client->tickets()->create([
      'tags'  => array('website_ticket_form'),
      'subject'  => 'New Message - '.$subj,
      'comment'  => array(
          'html_body' => $body,
          'public' => false
      ),
